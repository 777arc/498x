...
# Title: Sampling Demo
# Generated: Tue Aug 28 12:46:49 2018
...
class sampling_demo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/marc/498x/44k.wav', False)
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_keep_one_in_n_0, 0))
    ...
    def set_N(self, N):
        self.N = N
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, 44e3/self.N)
        self.qtgui_time_sink_x_0.set_samp_rate(44e3/self.N)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, 44e3/self.N)
        self.blocks_keep_one_in_n_0.set_n(self.N)


def main(top_block_cls=sampling_demo, options=None):
